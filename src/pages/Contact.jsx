...
const LostPropertyForm = ({ handleButtonClick }) => (
  <form
    action="https://formspree.io/f/xjkvvqag"
    method="POST"
    className="mt-6 border border-gray-200 shadow-lg py-6 pr-6 pl-6"
  >
    ...
    <button
      ...
      className="bg-black text-white px-6 py-2 ml-6"
    >
      Cancel
    </button>
  </form>
...
const FeedbackForm = ({ handleButtonClick }) => (
  ...
  >
    ...
    <textarea
      name="message"
      className="w-full mb-4 p-2 border"
      placeholder="What did we do well? What could we have done better?"
    ></textarea>
    <button type="submit" className="bg-black text-white px-6 py-2">
      Submit Feedback
    </button>
...
const FunctionForm = ({ handleButtonClick }) => (
  ...
  >
    ...
    <textarea
      name="message"
      className="w-full mb-4 p-2 border"
      placeholder="Day and time? Number of quests?"
    ></textarea>
    <button type="submit" className="bg-black text-white px-6 py-2">
      Submit Enquiry
    </button>
      ...
      <div className="w-[110vmin] p-6 bg-white mx-auto">
        {selectedOption === "" ? (
          ...
          <div className="flex justify-center">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pt-10 justify-center">
              {" "}
          ...
          <div className="flex items-center justify-center h-[50vh]">
            {selectedOption === "lost-property" && (
              <LostPropertyForm handleButtonClick={handleButtonClick} />
            )}
            {selectedOption === "enquiry" && (
              <EnquiryForm handleButtonClick={handleButtonClick} />
            )}
            {selectedOption === "feedback" && (
              <FeedbackForm handleButtonClick={handleButtonClick} />
            )}
            {selectedOption === "function" && (
              <FunctionForm handleButtonClick={handleButtonClick} />
            )}
          </div>
        )}
      </div>
...
const Tile = ({
  ...
  <div className="bg-white p-4 flex flex-col justify-between items-center h-[50vmin] w-[50vmin] border border-gray-200 shadow-lg">
    {" "}
